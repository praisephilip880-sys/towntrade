...
export const metadata = {
    ...
    openGraph: {
        title: 'TownTrade — Trade, Earn, and Connect Right in Your Neighborhood',
        description: 'The secure local marketplace where verified neighbors buy, sell, and trade with confidence — private chats, escrow-protected payments, and zero strangers.',
        type: 'website',
        siteName: 'TownTrade',
    },
};
