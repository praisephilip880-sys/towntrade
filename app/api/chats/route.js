...
const CHAT_SELECT = `
  SELECT
    ...
    u.id AS otherId, u.full_name AS otherName, u.neighborhood AS otherNeighborhood, u.location_verified AS otherVerified, u.is_admin AS otherIsAdmin, u.avatar AS otherAvatar,
...
export async function GET() {
    ...
    const chats = rows.map((r) => ({
        ...
        otherIsAdmin: r.otherIsAdmin === 1,
        otherAvatar: r.otherAvatar ?? null,
...
export async function POST(req) {
    ...
    return NextResponse.json({
        chat: {
            ...
            otherAvatar: row.otherAvatar ?? null,
