 ...
 */
import { NGN_PER_USD, OPAY_ACCOUNT_NAME, OPAY_ACCOUNT_NUMBER, OPAY_BANK, PLATFORM_FEE_RATE } from './constants';

/** The platform OPay account buyers transfer to (safe for client components). */
