...
export function getCurrentUser() {
    ...
    if (!token)
        return null;
    const row = db
        .prepare(`       SELECT u.id, u.full_name, u.email, u.neighborhood, u.location_verified, u.bank_connected, u.avatar, u.is_admin, u.safety_flags, u.selling_restricted_until, u.created_at, s.expires_at
