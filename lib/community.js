...
/** Recent real reviews for the landing-page testimonials (authentic social proof). */
export function fetchRecentReviews(limit = 4) {
    return db
        .prepare(`SELECT r.rating, r.comment, r.created_at AS createdAt,
              u.full_name AS reviewerName, u.neighborhood, u.avatar AS reviewerAvatar
       FROM reviews r
